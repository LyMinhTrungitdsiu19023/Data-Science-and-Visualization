...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            self.$tooltip = $("<div>").addClass(self.options.map.tooltip.cssClass).css("display", "none").css("margin-top", "40px");
        ...
        elemEnter: function (elem) {
            ...
            if (elem.options && elem.options.tooltip !== undefined) {
                ...
                self.$tooltip.html(content).css("display", "block").css("margin-top", "40px");
            }
